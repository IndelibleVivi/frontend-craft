...
它追求的是好看、可用的首个结果，解决根因且不丢失已认可成果的修改，以及随着相关经验积累，减少用户重复纠正的需要。这些是设计目标，不是经过测量的改进声明。
...
- **依据反馈修改。** 诊断“能用但很困惑”“太空了”“修一下间距，保留美术”背后的原因，并保留已被认可的部分。追踪同一种被否定处理的相关实例，分别判断修复要覆盖多广、构图需要改多深。
